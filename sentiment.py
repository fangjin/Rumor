...
def	get_content(): 
	try:
		con = lite.connect( "/home/jf/Documents/Rumor/Boston-back.db")
		f = open("./boston-after-small","a")				
		with con:			
			cur=con.cursor()			
			sql = "select text from t_rumor where createdAt>'2013-04-15 14:50:00' and createdAt<'2013-04-15 16:50:00'"
			cur.execute(sql)
			rs = cur.fetchall()			
			for r in rs:
				text = r[0]
...
def	get_sentiment(): 
	try:
		con = lite.connect( "/home/jf/Documents/Rumor/Boston-back.db")
		f = open("./boston-sentiment","a")				
		with con:			
			cur=con.cursor()			
			sql = "select sentiment from t_rumor where createdAt>'2013-04-15 14:50:00' and createdAt<'2013-04-15 16:50:00'"
			cur.execute(sql)
			rs = cur.fetchall()			
			for r in rs:
				sentiment = r[0]				
